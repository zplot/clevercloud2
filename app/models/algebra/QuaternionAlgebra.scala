...
case class QuaternionAlgebra(ring: Ring) {
  ...
  case class QAab (a: T0, b: T0) extends Ring {
    ...
    def conjugate(x: T2): T2 = {
      val comp1 = x.q._1
      val comp2 = x.q._2.neg
      val comp3 = x.q._3.neg
      val comp4 = x.q._4.neg
    ...
    class Quaternion private(val q: T1) extends RingElement {
      ...
      def neg: Quaternion = {
        val comp1 = this.q._1.neg
        val comp2 = this.q._2.neg
        val comp3 = this.q._3.neg
        val comp4 = this.q._4.neg
        builder(comp1, comp2, comp3, comp4)
      }

      def minus(other: Quaternion) = {
        val comp1 = this.q._1 + other.q._1.neg
        val comp2 = this.q._2 + other.q._2.neg
        val comp3 = this.q._3 + other.q._3.neg
        val comp4 = this.q._4 + other.q._4.neg
        builder(comp1, comp2, comp3, comp4)
      }
